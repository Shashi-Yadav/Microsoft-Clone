...
import Next from '../../../public/next1.svg';
...
//         <button
//           className='bg-[#0067b8] hover:bg-[#025a9f] text-white px-4 py-2'
//           onClick={handleNextSlide}
//         >
//           Next Slide
//         </button>
...
//   return (
//     <div>
//       <div className='py-4 px-4 bg-[#0067b8] text-white text-center group flex justify-center'>Require assistance with Microsoft 365? Call 0008004402127 to inquire or make a purchase.
//           <Image className="group-hover:translate-x-2 duration-300" src={Next}></Image>
//         </div>
//         <div className='flex'>
//       <div id='First' className='mb-10' >
